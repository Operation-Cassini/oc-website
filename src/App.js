...
//   const previousPageNumber = useRef(null); // Use useRef for previousPageNumber
...
//       console.log("previousPageNumber is!", previousPageNumber.current);
//       if (pageNum > 0 && previousPageNumber.current !== null && previousPageNumber.current !== pageNum - 1) {
...
//       }
//       else {
//         previousPageNumber.current = pageNum; // Only update after the check
//       }
//       // setPreviousPageNumber(pageNum);
